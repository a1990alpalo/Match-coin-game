...
def display_wallets(player1, player2):
    """Display the number of coins each player has."""
    print(f"{player1.get_name()} has {player1.get_wallet()} coins.")
    print(f"{player2.get_name()} has {player2.get_wallet()} coins.")


def play_round(player1, player2):
    """Play one round of the Match Coins game."""
    print("\nTossing...")
...
def display_final_results(player1, player2):
...
def main():
    ...
    display_wallets(player1, player2)
    ...
    display_final_results(player1, player2)
